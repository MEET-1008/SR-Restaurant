                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-0">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="form3Example1c" class="form-control" value="<?php echo $myname ?>" name="name" required/>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-0">
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="number" id="form3Example1c" class="form-control"  value="<?php echo $myprice ?>"name="price" required/>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="number" id="form3Example1c" class="form-control" value="<?php echo $myoffer ?>" name="offer" required/>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-outline flex-fill mb-0">
                                                <textarea type=" text" class="Description" name="description"  cols="46" rows="5" placeholder="Description" > <?php echo $my1description ?>"</textarea>
