...
<body>
  ...
  <div class="header welcome">
    <h1>
      <hr class="" />
      Welcome to Sagar Restaurant
      <hr class="mt-4" />

    </h1>
    <h5>Delivering great food for more than 10 years!</h5>
  </div>
  <div class="Events">
    ...
    <div class="container container-fluid ">
      <div class="row bg-light">
        <h1 class="text-center my-5">
          Organize Your Events in <span class="text-Primary"> our Restaurant</span>
        </h1>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6">

          <div>
            <p class="text-start">
            <h3 class="text-center">Birthday Parties</h3> <br />
            Restaurants are the most likely option for every birthday event be it a big one or a small one you can have
            a vast choice of venue options. You can easily locate a perfect restaurant for any of your parties. <br>
            Restaurants are perfect for birthday parties and can be a perfect solution for your parties, they can be
            used to host any kind of party or celebration, with ample space and you can organize the party the way you
            desire to.
            </p>
          </div>
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
          <img src="./img/birthday.jpg" class="img-fluid h-75 w-100 rounded-3 img-thumbnail shadow-lg" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1500">
        </div>
      </div>

      <div class="row bg-light">
        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
          <img src="./img/ma.jpg" class="img-fluid h-75 w-100 rounded-3 img-thumbnail shadow-lg" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1500">
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
          <div>
            <p class="text-start">
            <h3 class="text-center">Marriage Anniversary</h3> <br />
            Restaurants are the most likely option for every birthday event be it a big one or a small one you can have
            a vast choice of venue options. You can easily locate a perfect restaurant for any of your parties. <br>
            Restaurants are perfect for birthday parties and can be a perfect solution for your parties, they can be
            used to host any kind of party or celebration, with ample space and you can organize the party the way you
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 col-12">
          <div class="card bg-dark text-white mb-2">
            <div class="card-body">
              ...
              <a href="#" class="btn btn-primary bg-white text-dark">Go somewhere</a>
            </div>
          </div>
        </div>
        <div class="col-sm-12 col-md-6 col-lg-4 col-12">
